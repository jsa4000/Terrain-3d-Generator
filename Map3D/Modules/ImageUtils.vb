...
Public Class ImageUtils
    ...
    Public Shared Function GetMixedColor(fromColor As Double, toColor As Double, percentage As Double) As Integer
        ...
        Return Color.FromArgb(Convert.ToInt32(Hex(A), 16), Convert.ToInt32(Hex(R), 16), Convert.ToInt32(Hex(G), 16), Convert.ToInt32(Hex(B), 16)).ToArgb
    End Function
